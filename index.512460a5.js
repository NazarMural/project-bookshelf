 ...
 * limitations under the License.
 */
class Ms extends as{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),s=n.compareTo(i);return 0===s?di(e.name,t.name):s}makePost(e,t){const n=As(e),i=Rs.EMPTY_NODE.updateChild(this.indexPath_,n);return new os(t,i)}maxPost(){const e=Rs.EMPTY_NODE.updateChild(this.indexPath_,Ls);return new os("[MAX_NAME]",e)}toString(){return Gi(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,Ze(!Ki(e)&&".priority"!==Bi(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(er=Zs||(Zs={}))[er.OVERWRITE=0]="OVERWRITE",er[er.MERGE=1]="MERGE",er[er.ACK_USER_WRITE=2]="ACK_USER_WRITE",er[er.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class nr{operationForChild(e){if(Ki(this.path)){if(null!=this.affectedTree.value)return Ze(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ji(e));return new nr(qi(),t,this.revert)}}return Ze(Bi(this.path)===e,"operationForChild called for unrelated child."),new nr(Vi(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Zs.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ir{operationForChild(e){return Ki(this.path)?new ir(this.source,qi()):new ir(this.source,Vi(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=Zs.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{operationForChild(e){return Ki(this.path)?new sr(this.source,qi(),this.snap.getImmediateChild(e)):new sr(this.source,Vi(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Zs.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{operationForChild(e){if(Ki(this.path)){const t=this.children.subtree(new ji(e));return t.isEmpty()?null:t.value?new sr(this.source,qi(),t.value):new rr(this.source,qi(),t)}return Ze(Bi(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new rr(this.source,Vi(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Zs.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fr;class mr{static fromObject(e){let t=new mr(null);return mi(e,((e,n)=>{t=t.set(new ji(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:qi(),value:this.value};if(Ki(e))return null;{const n=Bi(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Vi(e),t);if(null!=s){return{path:Yi(new ji(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Ki(e))return this;{const t=Bi(e),n=this.children.get(t);return null!==n?n.subtree(Vi(e)):new mr(null)}}set(e,t){if(Ki(e))return new mr(t,this.children);{const n=Bi(e),i=(this.children.get(n)||new mr(null)).set(Vi(e),t),s=this.children.insert(n,i);return new mr(this.value,s)}}remove(e){if(Ki(e))return this.children.isEmpty()?new mr(null):new mr(null,this.children);{const t=Bi(e),n=this.children.get(t);if(n){const i=n.remove(Vi(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new mr(null):new mr(this.value,s)}return this}}get(e){if(Ki(e))return this.value;{const t=Bi(e),n=this.children.get(t);return n?n.get(Vi(e)):null}}setTree(e,t){if(Ki(e))return t;{const n=Bi(e),i=(this.children.get(n)||new mr(null)).setTree(Vi(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new mr(this.value,s)}}fold(e){return this.fold_(qi(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Yi(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,qi(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Ki(e))return null;{const i=Bi(e),s=this.children.get(i);return s?s.findOnPath_(Vi(e),Yi(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,qi(),t)}foreachOnPath_(e,t,n){if(Ki(e))return this;{this.value&&n(t,this.value);const i=Bi(e),s=this.children.get(i);return s?s.foreachOnPath_(Vi(e),Yi(t,i),n):new mr(null)}}foreach(e){this.foreach_(qi(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Yi(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(fr||(fr=new ps(ui)),fr))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(e,t,n,i,s){const r=new jr;let o,a;if(n.type===Zs.OVERWRITE){const l=n;l.source.fromUser?o=Gr(e,t,l.path,l.snap,i,s,r):(Ze(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Ki(l.path),o=$r(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===Zs.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const c=Yi(n,i);Xr(t,Bi(c))&&(a=Gr(e,a,c,l,s,r,o))})),i.foreach(((i,l)=>{const c=Yi(n,i);Xr(t,Bi(c))||(a=Gr(e,a,c,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(Ze(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Kr(e,t,l.path,l.children,i,s,a,r))}else if(n.type===Zs.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=Dr(i,n))return t;{const a=new Br(i,t,s),l=t.eventCache.getNode();let c;if(Ki(n)||".priority"===Bi(n)){let n;if(t.serverCache.isFullyInitialized())n=Ar(i,pr(t));else{const e=t.serverCache.getNode();Ze(e instanceof Rs,"serverChildren would be complete if leaf node"),n=Mr(i,e)}c=e.filter.updateFullNode(l,n,r)}else{const s=Bi(n);let d=Fr(i,s,t.serverCache);null==d&&t.serverCache.isCompleteForChild(s)&&(d=l.getImmediateChild(s)),c=null!=d?e.filter.updateChild(l,s,d,Vi(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,Rs.EMPTY_NODE,Vi(n),a,r):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Ar(i,pr(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=Dr(i,qi()),dr(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{onValue(e,t){this.snapshotCallback.call(null,e,t)}onCancel(e){return Ze(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}get hasCancelCallback(){return!!this.cancelCallback}matches(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}constructor(e,t){this.snapshotCallback=e,this.cancelCallback=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ql=new Map;function Bl(e){ml(e instanceof Function,"Expected a class definition");let t=ql.get(e);return t?(ml(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,ql.set(e,t),t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qc(e,t,n=!1){const i=await Ol(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Fc._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function gd(e,t){return t?Bl(t):(pl(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jd=new bl(5e3,15e3),qd={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Bd=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Hd(e){const t=e.config;pl(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?wl(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:"9.21.0"},s=Bd.get(e.config.apiHost);s&&(i.eid=s);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${zt(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const Qd=pt("authIdTokenMaxAge")||300;let Zd=null;var eu;eu="Browser",Nn(new Xt("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:r,authDomain:o}=n.options;pl(r&&!r.includes(":"),"invalid-api-key",{appName:n.name}),pl(!(null==o?void 0:o.includes(":")),"argument-error",{appName:n.name});const a={apiKey:r,authDomain:o,clientPlatform:eu,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:rc(eu)},l=new fc(n,i,s,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Bl);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(l,t),l}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Nn(new Xt("auth-internal",(e=>{const t=mc(e.getProvider("auth").getImmediate());return new Jd(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),On("@firebase/auth","0.23.1",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(eu)),On("@firebase/auth","0.23.1","esm2017");An({apiKey:"AIzaSyBwj1joeH7cezMQGrV_588ARC2goYFAeHk",authDomain:"book-e1fb3.firebaseapp.com",projectId:"book-e1fb3",storageBucket:"book-e1fb3.appspot.com",messagingSenderId:"701181474870",appId:"1:701181474870:web:8861dfbbd1f6265a608097",measurementId:"G-1S54659S3E"});const tu=function(e=Mn()){const t=Pn(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Pn(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ot(n.getOptions(),null!=t?t:{}))return e;cl(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Kd,persistence:[pd,Zc,td]}),i=pt("authTokenSyncURL");if(i){const e=(s=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Qd)return;const i=null==t?void 0:t.token;Zd!==i&&(Zd=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){Gt(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){Gt(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var s;const r=ut("auth");return r&&vc(n,`http://${r}`),n}();let nu=null,iu=!1;const su=document.querySelector(".js-list__nav"),ru=document.querySelector("[openSignUp]"),ou=document.querySelector(".modal__btn"),au=document.querySelector(".modal-book-btn__signUp");ru.addEventListener("click",Ru);const lu=document.querySelector(".mobile-menu--log-out"),cu=document.querySelector(".js-mobile__nav"),du=document.querySelector(".mobile-menu__singin--link"),uu=document.querySelector(".mobile-menu__user_name"),hu=document.querySelector(".mobile-menu__container");du.addEventListener("click",Ru);const pu=document.querySelector("[logOut]"),fu=document.querySelector(".log"),mu=document.querySelector(".show__icon");fu.addEventListener("click",_u),pu.addEventListener("click",_u),lu.addEventListener("click",_u);const gu={timeout:5e3};async function vu(e,t){return await Gc(tu,e,t)}async function yu(e,t){return await Xc(tu,e,t)}function _u(){var e;(e=tu,Gt(e).signOut()).then((()=>{localStorage.removeItem("uid"),iu=!1})).catch((e=>{}))}function bu(e){e?(iu=!0,su.classList.add("show"),pu.classList.add("show"),fu.classList.add("show"),ru.classList.remove("show"),su.closest(".header__box").classList.add("autorizationstyle"),lu.classList.add("show"),cu.classList.add("show"),du.classList.remove("show"),uu.classList.add("show"),hu.classList.add("show"),mu.classList.add("show"),localStorage.getItem("user-name")?(uu.textContent=localStorage.getItem("user-name"),pu.textContent=localStorage.getItem("user-name")):(uu.textContent="USER",pu.textContent="USER"),au.classList.add("is-hidden"),ou.classList.remove("is-hidden")):(iu=!1,su.classList.remove("show"),pu.classList.remove("show"),fu.classList.remove("show"),ru.classList.add("show"),su.closest(".header__box").classList.remove("autorizationstyle"),lu.classList.remove("show"),cu.classList.remove("show"),du.classList.add("show"),hu.classList.remove("show"),uu.classList.remove("show"),mu.classList.remove("show"),au.classList.remove("is-hidden"),ou.classList.add("is-hidden"))}function wu(e){if(iu&&nu){return Ya($a(nl(),`users/${nu}/${e._id}`),e),!0}return!1}function xu(e){if(iu&&nu){const n=$a(nl(),`users/${nu}/${e}`);return da("remove",(t=n)._path),Xa(t,null),!0}var t;return!1}async function ku(){let e=null;return await Kc(tu,(e=>{e&&(nu=e.uid)})),await Ka(Ga($a(nl()),`users/${nu}`)).then((t=>{t.exists()?(console.log(t.val()),e=[...Object.values(t.val())]):console.log("No data available")})).catch((e=>{console.error(e)})),e}localStorage.getItem("uid")&&(nu=localStorage.getItem("uid")),Kc(tu,(e=>{e?(nu=e.uid,localStorage.setItem("uid",nu),console.log("User signed in:",e),bu(e.emailVerified)):(localStorage.removeItem("uid"),iu=!1,bu(null),console.log("User signed out"))}));const Cu=document.querySelector("[modalSignUp]"),Tu=document.querySelector("[modalForm]"),Iu=document.querySelector("[buttonSignUp]"),Su=document.querySelector("[buttonSignIn]");Cu.addEventListener("click",(function(e){(e.target===e.currentTarget||e.target.closest(".k-modal__close"))&&Au()})),Tu.addEventListener("submit",(function(e){e.preventDefault();const{name:n,email:i,password:s}=e.target.elements;if(!Eu)return function(e,n){yu(e,n).then((e=>{console.log(e),nu=e.user.uid,localStorage.setItem("uid",nu),bu(e.user.emailVerified),Tu.reset(),Nu.forEach((e=>{e.classList.remove("hide-label")})),Au()})).catch((e=>{console.log(e),t(d).Notify.failure("Неверный пароль или почта!")}))}(i.value,s.value);n.value&&i.value&&s.value?vu(i.value,s.value).then((e=>{console.log(e),localStorage.setItem("user-name",n.value),Tu.reset(),Nu.forEach((e=>{e.classList.remove("hide-label")})),Au(),Yc(tu.currentUser).then((()=>{console.log("SENT EMAIL => CHECK"),t(d).Notify.success("Успешно зарегистрировано, проверьте почту для верификации!",gu)}))})).catch((e=>{console.log(e),t(d).Notify.failure("Случилась ошибка, повтори снова!")})):t(d).Notify.failure("Введите все поля!")})),Iu.addEventListener("click",(function(){Eu=!0,Pu(Iu,Su),Tu.elements.name.closest(".k-modal__block").style.display="block",Tu.publish.textContent="Sign up"})),Su.addEventListener("click",(function(){Eu=!1,Pu(Su,Iu),Tu.elements.name.closest(".k-modal__block").style.display="none",Tu.publish.textContent="Sign In"}));let Eu=!0;const Nu=document.querySelectorAll(".k-modal__input");function Pu(e,t){e.classList.add("active"),t.classList.remove("active")}function Ru(){Cu.classList.add("k-modal--active"),document.body.style.overflow="hidden",document.addEventListener("keydown",Lu)}function Lu(e){"Escape"===e.code&&Au()}function Au(){Cu.classList.remove("k-modal--active"),document.body.style.overflow="overlay",document.removeEventListener("keydown",Lu)}Nu.forEach((e=>{e.addEventListener("input",(e=>{e.target.value?e.target.classList.add("hide-label"):e.target.classList.remove("hide-label")}))}));const Mu=document.querySelector(".books-cards__list"),Ou=document.querySelector(".backdrop--hidden"),Du=document.querySelector(".close-btn"),zu=document.querySelector(".book-container"),Fu=document.querySelector(".modal__btn"),Wu=document.querySelector(".modal-book-btn__signUp");function Uu(){Ou.classList.add("backdrop--hidden"),zu.innerHTML=""}Mu.addEventListener("click",(async function(e){let t=!0;if("DIV"===e.target.nodeName||"P"===e.target.nodeName||"H2"===e.target.nodeName||"A"===e.target.nodeName){Du.addEventListener("click",Uu);const n=e.target.closest(".category-books__item").dataset.id;Ou.classList.remove("backdrop--hidden");const i=await o(n);zu.insertAdjacentHTML("beforeend",function({_id:e,book_image:t,buy_links:n,title:i,description:s,author:r}){const o=`<img src="${t}" alt="${i}" />\n  <h2>${i}</h2>\n  <p>${r}</p>\n  <p>${s}</p>\n  <svg width="10" height="10"><use href="${n}"></use></svg>`;return Fu.dataset.id=`${e}`,o}(i));const s=await ku();if(null!==s)for(let e=0;e<s.length;e++)if(s[e]._id===n){t=!1;break}Fu.textContent=t?"Add to shopping list":"Remove from the shopping list"}})),Wu.addEventListener("click",Ru),Fu.addEventListener("click",(async function(e){let t=!0;const n=await ku(),i=Fu.dataset.id,s=await o(i);if(null!==n)for(let e=0;e<n.length;e++)if(n[e]._id===i){t=!1;break}t?(wu(s),Fu.textContent="Remove from the shopping list"):(xu(i),Fu.textContent="Add to shopping list")}));const ju=document.querySelector("body"),qu=document.querySelector(".header"),Bu=document.querySelector(".logo__text"),Hu=document.querySelector("#toggle"),Vu=document.querySelector(".js-open-menu"),$u=document.querySelector(".js-link-home"),Gu=document.querySelector(".js-link-shoping"),Xu=document.querySelector(".js-icon"),Yu=document.querySelector(".icon__burger--open"),Ku=document.querySelector(".js-close-menu"),Ju=document.querySelector(".icon__burger--close");Hu.addEventListener("click",(function(e){console.log(e.currentTarget),ju.classList.toggle("dark-theme"),qu.classList.toggle("dark"),Bu.classList.toggle("dark__icon"),Vu.classList.toggle("button-black"),Yu.classList.toggle("icon-black"),Ku.classList.toggle("button-black"),Ju.classList.toggle("icon-black"),$u.classList.contains("current")||$u.classList.toggle("dark__text");Gu.classList.contains("current")||Gu.classList.toggle("dark__text");Xu.classList.contains("current")||Xu.classList.toggle("dark__icon")}));const Qu=document.querySelector(".js-open-menu"),Zu=document.querySelector(".js-close-menu"),eh=document.querySelector(".js-menu-container");Qu.addEventListener("click",(function(){Qu.classList.add("is-open"),eh.classList.add("is-open"),Qu.classList.contains("is-open")&&(Zu.classList.add("is-open"),Zu.classList.toggle("block"),Qu.style.display="none")})),Zu.addEventListener("click",(function(){Qu.classList.remove("is-open"),Zu.classList.toggle("block"),Zu.classList.remove("is-open"),eh.classList.remove("is-open"),Qu.style.display="block"}));getComputedStyle(Zu).display;let th=null;!function(){for(let e in localStorage){if(!localStorage.hasOwnProperty(e))continue;console.log("key ==>",e),console.log(localStorage.getItem(e));const{img:t,description:n,title:i,author:s,genre:r}=JSON.parse(localStorage.getItem(e));th+=`<div>\n            <img src="${t}" alt=""/>\n            <div class="main_description">\n                <div>\n                    <div>\n                        <h3>${i}</h3>\n                        <p>${r}</p>\n                    </div>\n                    <button></button>\n                </div>\n                <p>${n}</p>\n                <div>\n                    <span>${s}</span>\n                    <span></span>\n                </div>\n            </div>\n        </div>`}if(!th)return document.querySelector("#shoplist__main").insertAdjacentHTML("beforeend",'<include src="./partials/shoppingList.html"></include>');document.querySelector("#shoplist__main").insertAdjacentHTML("beforeend",th)}();
//# sourceMappingURL=index.512460a5.js.map
